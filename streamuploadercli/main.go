// Package streamuploadercli exposes the standard streamuploader command entry
// point for custom binaries that need to link authentication middleware.
package streamuploadercli
